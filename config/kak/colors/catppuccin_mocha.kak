...
set-face	global	LineNumberCursor		"%opt{lavender},%opt{background}"
...
set-face	global	Information					"%opt{rosewater},%opt{mantle}"
...
set-face	global	MatchingChar				"%opt{peach},%opt{black3}"
