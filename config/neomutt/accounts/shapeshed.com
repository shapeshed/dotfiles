source ~/.config/neomutt/colors/catppuccin-mocha.muttrc
# Commands
...
set hdrs                          =   yes
set header                        =   no
set header_cache                  =   "~/.cache/neomutt/shapeshed/headers"
...
set sig_dashes                    =   yes
set sig_on_top                    =   no
set signature                     =   "~/.config/mutt/signatures/shapeshed.com.txt"
